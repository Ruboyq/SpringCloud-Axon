package com.group1.hw.user;

import com.group1.hw.user.command.CustomerDepositCommand;
...
import com.group1.hw.user.command.CustomerChargeCommand;
import com.group1.hw.user.command.CustomerCreateCommand;
import com.group1.hw.user.event.*;
...
public class Customer {
    ...
    public void handle(OrderPayCommand command) {
        if (this.getDeposit() < command.getAmount()) {
