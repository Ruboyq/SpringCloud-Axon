package com.group1.hw.user.config;
...
public class AxonConfig {
    ...
    public Binding userQueueBinding() {
        return BindingBuilder.bind(userQueue()).to(exchange()).with("com.group1.hw.user.event.#").noargs();
    }
    ...
    public Binding ticketSagaQueueBinding() {
        return BindingBuilder.bind(ticketSagaQueue()).to(exchange()).with("com.group1.hw.user.event.saga.#").noargs();
    }
